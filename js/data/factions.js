...
const FACTIONS = {
  ...
  norse:     { name: 'Norse',     unique: 'hirdman',      bonus: 'Woodcutters gather 10% faster; docks build boats 25% faster.',
               blurb: 'Raiders and shipwrights from the northern fjords.', effect: { gather: { wood: 0.1 }, trainCls: { ship: 0.25 } } },
